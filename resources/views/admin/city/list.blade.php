                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{route('admin_addcity')}}" class="btn green"> Add New
                        ...
                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" title="Edit" href="{{ url('Admin-EditCity/'.$rowData->id)}}"> <i class="fa fa-pencil"></i> </a>
                                        <a class="btn btn-sm btn-danger" title="Delete" href="{{ url('Admin-DeleteCity/'.$rowData->id)}}"> <i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                                @php $i++; @endphp
                                @endforeach
