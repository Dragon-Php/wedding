            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        {{ Form::open(['url' => url('Admin-EditCountry/'.\Request::segment(2)), 'class'=>'form-horizontal','files' => true ])}}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->name}}" name="name" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->iso3}}" name="iso3" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->iso2}}" name="iso2" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->countrycode}}" name="countrycode" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->phonecode}}" name="phonecode" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->capital}}" name="capital" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $editData->currency}}" name="currency" data-required="1" class="form-control" /> 
