            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        {{ Form::open(['url' => route('admin_addblog'), 'class'=>'form-horizontal','files' => true ])}}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="auther" data-required="1" class="form-control" /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea name="short_description" rows="10" class="form-control" /></textarea> 
